...
function chart(canvas, data) {
  ...
  function paint() {
    ...
    yData.map(toCoords(xRatio, yRatio)).forEach(function (coords, idx) {
      ...
      (0, _utils.line)(ctx, coords, color);
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          if ((0, _utils.isOver)(proxy.mouse, x, coords.length, DPI_HEIGHT, DPI_HEIGHT)) {
  ...
  function xAxis(xData, xRatio) {
    ...
    for (var i = 1; i < xData.length; i++) {
      ...
      if ((0, _utils.isOver)(proxy.mouse, x, xData.length)) {
        ctx.save();
  ...
  function yAxis(yMin, yMax) {
    var step = VIEW_HEIGHT / ROW_COUNTS;
    var textStep = (yMax - yMin) / ROW_COUNTS;
    ctx.beginPath();
    ctx.lineWidth = 1;
    ctx.strokeStyle = '#bbb';
...
tgChart.init();
},{"./data":"data.js","./chart":"chart.js","./styles.scss":"styles.scss"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
